...
function resetUnits() {
  units = [
    ...
    },
    {
      ...
      name: "Bất phương trình bậc nhất một ẩn",
      levels: [
        { name: "Khái niệm bất phương trình bậc nhất một ẩn", state: "unlock" },
        { name: "Cách giải bất phương trình bậc nhất một ẩn", state: "unlock" },
        { name: "Vận dụng", state: "unlock" },
    ...
    },
    {
      ...
      name: "Một số hệ thức giữa cạnh, góc trong tam giác vuông và ứng dụng",
      levels: [
        { name: "Hệ thức giữa cạnh huyền và cạnh góc vuông", state: "unlock" },
        { name: "Hệ thức giữa hai cạnh góc vuông", state: "unlock" },
    ...
    },
    {
      id: 13,
      name: "Mở đầu về đường tròn",
      levels: [{ name: "Đường tròn", state: "unlock" }],
    },
    {
      id: 14,
      name: "Cung và dây của một đường tròn",
    ...
    },
    {
      ...
      levels: [
        ...
        { name: "Hai tiếp tuyến cắt nhau của một đường tròn", state: "unlock" },
        { name: "Vận dụng", state: "unlock" },
      ],
    },
    {
    ...
    },
    {
      id: 22,
      name: `Bảng tần số và biểu đồ tần số`,
      levels: [{ name: "Vận dụng", state: "unlock" }],
    },
    {
      id: 23,
      name: `Bảng tần số tương đối và biểu đồ tần số tương đối`,
    ...
    },
    {
      ...
      name: `Đường tròn ngoại tiếp và đường tròn nội tiếp của một tam giác`,
      levels: [
        { name: "Đường tròn ngoại tiếp một tam giác", state: "unlock" },
        { name: "Đường tròn nội tiếp một tam giác", state: "unlock" },
        { name: "Vận dụng", state: "unlock" },
      ],
    },
    {
      ...
      name: `Tứ giác nội tiếp`,
      levels: [
        { name: "Đường tròn ngoại tiếp một tứ giác", state: "unlock" },
        {
          name: "Đường tròn ngoại tiếp hình chữ nhật và hình vuông",
          state: "unlock",
        },
    ...
    },
    {
      ...
      name: `Hình trụ và hình nón`,
      levels: [
        { name: "Hình trụ", state: "unlock" },
        { name: "Hình nón", state: "unlock" },
        { name: "Vận dụng", state: "unlock" },
      ],
    },
    {
      ...
      name: `Hình cầu`,
      levels: [
        { name: "Diện tích mặt cầu và thể tích hình cầu", state: "unlock" },
        { name: "Vận dụng", state: "unlock" },
